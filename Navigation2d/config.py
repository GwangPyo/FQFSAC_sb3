...
def transform(x):
    return [denormalize_position(x[0], W, H), denormalize_position(x[1], W, H), x[2]]
...
obs_set = [
    ...
    [transform([[0.1, 0.1], [0.8, 0.1], HORIZONTAL]),
     transform([[0.1, 0.8], [0.8, 0.8], HORIZONTAL]),
     transform([[0.2, 0.2], [0.6, 0.6], CIRCULAR])],
...
test_goal_set =  denormalize_position([0.45, 0.924], W, H)
